...
import { BulkDiscountInputModule } from './extensions/9d0b65e8bb4cc57252c73043d2418222b31917b92e0726895c83729eff1f7f68/bulk-discount-input.module';
...
@NgModule({
    imports: [CommonModule, WidgetModule, NavBarHidingModule, InStorePickupModule, FavoritesUiExtensionModule, SubscriptionExtensionModule, VendorExtensionModule, FeedbackExtensionModule, ReviewsUiExtensionModule, BulkDiscountInputModule, ProductRecommendationsInputModule],
})
